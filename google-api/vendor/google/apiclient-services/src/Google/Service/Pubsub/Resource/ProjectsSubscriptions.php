...
class Google_Service_Pubsub_Resource_ProjectsSubscriptions extends Google_Service_Resource
{
     ...
     *            The subscription whose message is being
     ...
     * All messages retained in the subscription
     ...
     * Note that certain properties of a
     ...
     *
     * @param string $subscription
     *            The subscription from which messages should be
