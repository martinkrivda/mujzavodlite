...
class Google_Service_Pubsub_Resource_ProjectsSnapshots extends Google_Service_Resource
{
     ...
     *
     * @param string $name
     *            Optional user-provided name for this snapshot. If the
     ...
     * All messages retained in the snapshot are
     ...
     *            The name of the cloud project that snapshots belong
     ...
     * Note that certain properties of a snapshot are
