...
class Google_Service_Customsearch extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->cse = new Google_Service_Customsearch_Resource_Cse($this, $this->serviceName, 'cse', array(
            'methods' => array(
                'list' => array(
                    'path' => 'v1',
                    'httpMethod' => 'GET',
        ...
        $this->cse_siterestrict = new Google_Service_Customsearch_Resource_CseSiterestrict($this, $this->serviceName, 'siterestrict', array(
            'methods' => array(
                'list' => array(
