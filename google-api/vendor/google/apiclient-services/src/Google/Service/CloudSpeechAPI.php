...
class Google_Service_CloudSpeechAPI extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->operations = new Google_Service_CloudSpeechAPI_Resource_Operations($this, $this->serviceName, 'operations', array(
            'methods' => array(
                'cancel' => array(
        ...
        $this->speech = new Google_Service_CloudSpeechAPI_Resource_Speech($this, $this->serviceName, 'speech', array(
            'methods' => array(
