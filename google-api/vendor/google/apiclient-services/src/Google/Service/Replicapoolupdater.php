...
class Google_Service_Replicapoolupdater extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->rollingUpdates = new Google_Service_Replicapoolupdater_Resource_RollingUpdates($this, $this->serviceName, 'rollingUpdates', array(
            'methods' => array(
                'cancel' => array(
        ...
        $this->zoneOperations = new Google_Service_Replicapoolupdater_Resource_ZoneOperations($this, $this->serviceName, 'zoneOperations', array(
            'methods' => array(
                'get' => array(
