...
class Google_Service_Genomics extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->annotations = new Google_Service_Genomics_Resource_Annotations($this, $this->serviceName, 'annotations', array(
            'methods' => array(
                'batchCreate' => array(
        ...
        $this->annotationsets = new Google_Service_Genomics_Resource_Annotationsets($this, $this->serviceName, 'annotationsets', array(
            'methods' => array(
                'create' => array(
        ...
        $this->callsets = new Google_Service_Genomics_Resource_Callsets($this, $this->serviceName, 'callsets', array(
            'methods' => array(
                'create' => array(
                    'path' => 'v1/callsets',
                    'httpMethod' => 'POST',
        ...
        $this->datasets = new Google_Service_Genomics_Resource_Datasets($this, $this->serviceName, 'datasets', array(
            'methods' => array(
                'create' => array(
                    'path' => 'v1/datasets',
                    'httpMethod' => 'POST',
        ...
        $this->operations = new Google_Service_Genomics_Resource_Operations($this, $this->serviceName, 'operations', array(
            'methods' => array(
                'cancel' => array(
                    'path' => 'v1/{+name}:cancel',
                    'httpMethod' => 'POST',
        ...
        $this->readgroupsets = new Google_Service_Genomics_Resource_Readgroupsets($this, $this->serviceName, 'readgroupsets', array(
            'methods' => array(
                'delete' => array(
        ...
        $this->readgroupsets_coveragebuckets = new Google_Service_Genomics_Resource_ReadgroupsetsCoveragebuckets($this, $this->serviceName, 'coveragebuckets', array(
            'methods' => array(
                'list' => array(
        ...
        $this->reads = new Google_Service_Genomics_Resource_Reads($this, $this->serviceName, 'reads', array(
            'methods' => array(
                'search' => array(
        ...
        $this->references = new Google_Service_Genomics_Resource_References($this, $this->serviceName, 'references', array(
            'methods' => array(
                'get' => array(
        ...
        $this->references_bases = new Google_Service_Genomics_Resource_ReferencesBases($this, $this->serviceName, 'bases', array(
            'methods' => array(
                'list' => array(
        ...
        $this->referencesets = new Google_Service_Genomics_Resource_Referencesets($this, $this->serviceName, 'referencesets', array(
            'methods' => array(
                'get' => array(
        ...
        $this->variants = new Google_Service_Genomics_Resource_Variants($this, $this->serviceName, 'variants', array(
            'methods' => array(
                'create' => array(
                    'path' => 'v1/variants',
                    'httpMethod' => 'POST',
        ...
        $this->variantsets = new Google_Service_Genomics_Resource_Variantsets($this, $this->serviceName, 'variantsets', array(
            'methods' => array(
                'create' => array(
                    'path' => 'v1/variantsets',
                    'httpMethod' => 'POST',
