...
class Google_Service_Cih_Resource_UserInteractions extends Google_Service_Resource
{
    ...
    /**
     * Gets an interaction.
     * (userInteractions.get)
     *
     * @param string $entityType
     *            Represents the Type of the entity whose interaction
     *            will be returned. Possible Values: COMPANY, ADWORDS_CID, EMAIL,
     *            ADDRESS_DIGEST, GAIA_ID.
     * @param string $entityId
     *            Represents the Id of the Entity whose interaction
     *            will be returned.
     * @param string $timestamp
     *            the timestamp of the interaction to be returned. It
     ...
     * requested.
     * The returned list is sorted by timestamp in descending order.
     * (userInteractions.listUserInteractions)
     *
     * @param string|array $entity
     *            List of entities to retrieve. At least one item
