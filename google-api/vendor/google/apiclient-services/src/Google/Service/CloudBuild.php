...
class Google_Service_CloudBuild extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->operations = new Google_Service_CloudBuild_Resource_Operations($this, $this->serviceName, 'operations', array(
            'methods' => array(
                'cancel' => array(
                    'path' => 'v1/{+name}:cancel',
                    'httpMethod' => 'POST',
        ...
        $this->projects_builds = new Google_Service_CloudBuild_Resource_ProjectsBuilds($this, $this->serviceName, 'builds', array(
            'methods' => array(
                'cancel' => array(
        ...
        $this->projects_triggers = new Google_Service_CloudBuild_Resource_ProjectsTriggers($this, $this->serviceName, 'triggers', array(
            'methods' => array(
                'create' => array(
