...
class Google_Service_CloudFunctions_Resource_ProjectsLocationsFunctions extends Google_Service_Resource
{
     ...
     * To be used for testing, very limited
     ...
     * If a function with the given name already exists in
     * the specified project, the long running operation will return
     * `ALREADY_EXISTS` error. (functions.create)
     *
     * @param string $location
     *            The project and location in which the function should
     ...
     *
     * @param string $name
     *            The name of function for which source code Google Cloud
    ...
    public function generateDownloadUrl($name, Google_Service_CloudFunctions_GenerateDownloadUrlRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('generateDownloadUrl', array(
            $params
     ...
     *
     * @param string $parent
     *            The project and location in which the Google Cloud
    ...
    public function generateUploadUrl($parent, Google_Service_CloudFunctions_GenerateUploadUrlRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('generateUploadUrl', array(
            $params
     ...
     *
     * @param string $name
     *            The name of the function which details should be
     *            obtained.
     * @param array $optParams
     *            Optional parameters.
     ...
     *
     * @param string $parent
     *            The project and location from which the function should
