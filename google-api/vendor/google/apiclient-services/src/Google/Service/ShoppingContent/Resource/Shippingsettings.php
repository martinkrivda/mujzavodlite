...
class Google_Service_ShoppingContent_Resource_Shippingsettings extends Google_Service_Resource
{
     ...
     *            The ID of the managing account. If this parameter
     ...
     *
     * @param string $merchantId
     *            The ID of the account for which to retrieve the
     *            supported carriers.
     * @param array $optParams
     *            Optional parameters.
    ...
    public function getsupportedcarriers($merchantId, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('getsupportedcarriers', array(
            $params
     ...
     *
     * @param string $merchantId
     *            The ID of the managing account. This must be a
