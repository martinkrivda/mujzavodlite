...
class Google_Service_Slides extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->presentations = new Google_Service_Slides_Resource_Presentations($this, $this->serviceName, 'presentations', array(
            'methods' => array(
                'batchUpdate' => array(
        ...
        $this->presentations_pages = new Google_Service_Slides_Resource_PresentationsPages($this, $this->serviceName, 'pages', array(
            'methods' => array(
                'get' => array(
