...
class Google_Service_StreetViewPublish extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->photo = new Google_Service_StreetViewPublish_Resource_Photo($this, $this->serviceName, 'photo', array(
            'methods' => array(
                'create' => array(
                    'path' => 'v1/photo',
                    'httpMethod' => 'POST',
        ...
        $this->photos = new Google_Service_StreetViewPublish_Resource_Photos($this, $this->serviceName, 'photos', array(
            'methods' => array(
                'batchDelete' => array(
