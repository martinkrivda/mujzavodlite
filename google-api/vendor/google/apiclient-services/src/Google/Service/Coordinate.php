...
class Google_Service_Coordinate extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->customFieldDef = new Google_Service_Coordinate_Resource_CustomFieldDef($this, $this->serviceName, 'customFieldDef', array(
            'methods' => array(
                'list' => array(
        ...
        $this->jobs = new Google_Service_Coordinate_Resource_Jobs($this, $this->serviceName, 'jobs', array(
            'methods' => array(
                'get' => array(
        ...
        $this->location = new Google_Service_Coordinate_Resource_Location($this, $this->serviceName, 'location', array(
            'methods' => array(
                'list' => array(
        ...
        $this->schedule = new Google_Service_Coordinate_Resource_Schedule($this, $this->serviceName, 'schedule', array(
            'methods' => array(
                'get' => array(
        ...
        $this->team = new Google_Service_Coordinate_Resource_Team($this, $this->serviceName, 'team', array(
            'methods' => array(
                'list' => array(
                    'path' => 'teams',
                    'httpMethod' => 'GET',
        ...
        $this->worker = new Google_Service_Coordinate_Resource_Worker($this, $this->serviceName, 'worker', array(
            'methods' => array(
                'list' => array(
