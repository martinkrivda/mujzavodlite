...
class Google_Service_YouTube_Resource_LiveChatMessages extends Google_Service_Resource
{
     ...
     *
     * @param string $id
     *            The id parameter specifies the YouTube chat message ID of
     ...
     *
     * @param string $part
     *            The part parameter serves two purposes. It identifies the
     ...
     *            The liveChatId parameter specifies the ID of the
     *            chat whose messages will be returned.
     * @param string $part
     *            The part parameter specifies the liveChatComment resource
