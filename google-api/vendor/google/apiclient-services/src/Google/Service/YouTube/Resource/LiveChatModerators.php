...
class Google_Service_YouTube_Resource_LiveChatModerators extends Google_Service_Resource
{
     ...
     *
     * @param string $id
     *            The id parameter identifies the chat moderator to remove.
     ...
     *            The liveChatId parameter specifies the YouTube live
     *            chat for which the API should return moderators.
     * @param string $part
     *            The part parameter specifies the liveChatModerator
