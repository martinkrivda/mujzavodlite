...
class Google_Service_ServiceRegistry extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->endpoints = new Google_Service_ServiceRegistry_Resource_Endpoints($this, $this->serviceName, 'endpoints', array(
            'methods' => array(
                'delete' => array(
        ...
        $this->operations = new Google_Service_ServiceRegistry_Resource_Operations($this, $this->serviceName, 'operations', array(
            'methods' => array(
                'get' => array(
