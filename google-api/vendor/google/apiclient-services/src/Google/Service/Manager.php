...
class Google_Service_Manager extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->deployments = new Google_Service_Manager_DeploymentsResource($this, $this->serviceName, 'deployments', array(
            'methods' => array(
                'delete' => array(
        ...
        $this->templates = new Google_Service_Manager_TemplatesResource($this, $this->serviceName, 'templates', array(
            'methods' => array(
                'delete' => array(
