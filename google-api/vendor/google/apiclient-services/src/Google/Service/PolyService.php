...
class Google_Service_PolyService extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->assets = new Google_Service_PolyService_Resource_Assets($this, $this->serviceName, 'assets', array(
            'methods' => array(
                'get' => array(
                    'path' => 'v1/{+name}',
                    'httpMethod' => 'GET',
        ...
        $this->users_assets = new Google_Service_PolyService_Resource_UsersAssets($this, $this->serviceName, 'assets', array(
            'methods' => array(
                'list' => array(
                    'path' => 'v1/{+name}/assets',
                    'httpMethod' => 'GET',
        ...
        $this->users_likedassets = new Google_Service_PolyService_Resource_UsersLikedassets($this, $this->serviceName, 'likedassets', array(
            'methods' => array(
                'list' => array(
