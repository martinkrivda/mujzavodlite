...
class Google_Service_DoubleClickBidManager extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->lineitems = new Google_Service_DoubleClickBidManager_Resource_Lineitems($this, $this->serviceName, 'lineitems', array(
            'methods' => array(
        ...
        $this->queries = new Google_Service_DoubleClickBidManager_Resource_Queries($this, $this->serviceName, 'queries', array(
            'methods' => array(
                'createquery' => array(
                    'path' => 'query',
                    'httpMethod' => 'POST',
        ...
        $this->reports = new Google_Service_DoubleClickBidManager_Resource_Reports($this, $this->serviceName, 'reports', array(
            'methods' => array(
                'listreports' => array(
        ...
        $this->sdf = new Google_Service_DoubleClickBidManager_Resource_Sdf($this, $this->serviceName, 'sdf', array(
            'methods' => array(
                'download' => array(
                    'path' => 'sdf/download',
                    'httpMethod' => 'POST',
