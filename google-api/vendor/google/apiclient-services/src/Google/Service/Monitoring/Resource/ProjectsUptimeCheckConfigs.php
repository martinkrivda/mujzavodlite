...
class Google_Service_Monitoring_Resource_ProjectsUptimeCheckConfigs extends Google_Service_Resource
{
     ...
     * Note that this method will fail if the
     ...
     *
     * @param string $parent
     *            The project whose uptime check configurations are
     ...
     * You can either replace the entire
     * configuration with a new one or replace only certain fields in the current
     * configuration by specifying the fields to be updated via "updateMask".
     * Returns the updated configuration. (uptimeCheckConfigs.patch)
     *
     * @param string $name
     *            A unique resource name for this UptimeCheckConfig. The
