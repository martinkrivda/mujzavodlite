...
class Google_Service_ServiceManagement extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->operations = new Google_Service_ServiceManagement_Resource_Operations($this, $this->serviceName, 'operations', array(
            'methods' => array(
                'get' => array(
                    'path' => 'v1/{+name}',
                    'httpMethod' => 'GET',
        ...
        $this->services = new Google_Service_ServiceManagement_Resource_Services($this, $this->serviceName, 'services', array(
            'methods' => array(
                'create' => array(
                    'path' => 'v1/services',
                    'httpMethod' => 'POST',
        ...
        $this->services_configs = new Google_Service_ServiceManagement_Resource_ServicesConfigs($this, $this->serviceName, 'configs', array(
            'methods' => array(
                'create' => array(
        ...
        $this->services_consumers = new Google_Service_ServiceManagement_Resource_ServicesConsumers($this, $this->serviceName, 'consumers', array(
            'methods' => array(
                'getIamPolicy' => array(
                    'path' => 'v1/{+resource}:getIamPolicy',
                    'httpMethod' => 'POST',
        ...
        $this->services_rollouts = new Google_Service_ServiceManagement_Resource_ServicesRollouts($this, $this->serviceName, 'rollouts', array(
            'methods' => array(
                'create' => array(
