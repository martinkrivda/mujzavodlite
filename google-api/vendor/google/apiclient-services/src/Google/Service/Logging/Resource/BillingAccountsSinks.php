...
class Google_Service_Logging_Resource_BillingAccountsSinks extends Google_Service_Resource
{
    ...
    /**
     * Deletes a sink.
     * If the sink has a unique writer_identity, then that service
     * account is also deleted. (sinks.delete)
     *
     * @param string $sinkName
     *            Required. The full resource name of the sink to
    ...
    /**
     * Lists sinks.
     * (sinks.listBillingAccountsSinks)
     *
     * @param string $parent
    ...
    /**
     * Updates a sink.
     * This method replaces the following fields in the existing
