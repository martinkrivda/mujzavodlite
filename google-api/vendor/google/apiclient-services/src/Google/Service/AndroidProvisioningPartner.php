...
class Google_Service_AndroidProvisioningPartner extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->operations = new Google_Service_AndroidProvisioningPartner_Resource_Operations($this, $this->serviceName, 'operations', array(
            'methods' => array(
                'get' => array(
                    'path' => 'v1/{+name}',
                    'httpMethod' => 'GET',
        ...
        $this->partners_customers = new Google_Service_AndroidProvisioningPartner_Resource_PartnersCustomers($this, $this->serviceName, 'customers', array(
            'methods' => array(
                'create' => array(
        ...
        $this->partners_devices = new Google_Service_AndroidProvisioningPartner_Resource_PartnersDevices($this, $this->serviceName, 'devices', array(
            'methods' => array(
                'claim' => array(
