...
class Google_Service_TagManager extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->accounts = new Google_Service_TagManager_Resource_Accounts($this, $this->serviceName, 'accounts', array(
            'methods' => array(
                'get' => array(
                    'path' => '{+path}',
                    'httpMethod' => 'GET',
        ...
        $this->accounts_containers = new Google_Service_TagManager_Resource_AccountsContainers($this, $this->serviceName, 'containers', array(
            'methods' => array(
                'create' => array(
        ...
        $this->accounts_containers_environments = new Google_Service_TagManager_Resource_AccountsContainersEnvironments($this, $this->serviceName, 'environments', array(
            'methods' => array(
                'create' => array(
        ...
        $this->accounts_containers_version_headers = new Google_Service_TagManager_Resource_AccountsContainersVersionHeaders($this, $this->serviceName, 'version_headers', array(
            'methods' => array(
                'latest' => array(
        ...
        $this->accounts_containers_versions = new Google_Service_TagManager_Resource_AccountsContainersVersions($this, $this->serviceName, 'versions', array(
            'methods' => array(
                'delete' => array(
                    'path' => '{+path}',
                    'httpMethod' => 'DELETE',
        ...
        $this->accounts_containers_workspaces = new Google_Service_TagManager_Resource_AccountsContainersWorkspaces($this, $this->serviceName, 'workspaces', array(
            'methods' => array(
                'create' => array(
        ...
        $this->accounts_containers_workspaces_built_in_variables = new Google_Service_TagManager_Resource_AccountsContainersWorkspacesBuiltInVariables($this, $this->serviceName, 'built_in_variables', array(
            'methods' => array(
                'create' => array(
        ...
        $this->accounts_containers_workspaces_folders = new Google_Service_TagManager_Resource_AccountsContainersWorkspacesFolders($this, $this->serviceName, 'folders', array(
            'methods' => array(
                'create' => array(
                    'path' => '{+parent}/folders',
                    'httpMethod' => 'POST',
        ...
        $this->accounts_containers_workspaces_proposal = new Google_Service_TagManager_Resource_AccountsContainersWorkspacesProposal($this, $this->serviceName, 'proposal', array(
            'methods' => array(
                'create' => array(
        ...
        $this->accounts_containers_workspaces_tags = new Google_Service_TagManager_Resource_AccountsContainersWorkspacesTags($this, $this->serviceName, 'tags', array(
            'methods' => array(
                'create' => array(
                    'path' => '{+parent}/tags',
                    'httpMethod' => 'POST',
        ...
        $this->accounts_containers_workspaces_triggers = new Google_Service_TagManager_Resource_AccountsContainersWorkspacesTriggers($this, $this->serviceName, 'triggers', array(
            'methods' => array(
                'create' => array(
        ...
        $this->accounts_containers_workspaces_variables = new Google_Service_TagManager_Resource_AccountsContainersWorkspacesVariables($this, $this->serviceName, 'variables', array(
            'methods' => array(
                'create' => array(
        ...
        $this->accounts_user_permissions = new Google_Service_TagManager_Resource_AccountsUserPermissions($this, $this->serviceName, 'user_permissions', array(
            'methods' => array(
                'create' => array(
