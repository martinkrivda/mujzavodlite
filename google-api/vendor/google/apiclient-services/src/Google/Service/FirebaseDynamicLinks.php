...
class Google_Service_FirebaseDynamicLinks extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->shortLinks = new Google_Service_FirebaseDynamicLinks_Resource_ShortLinks($this, $this->serviceName, 'shortLinks', array(
            'methods' => array(
                'create' => array(
                    'path' => 'v1/shortLinks',
                    'httpMethod' => 'POST',
        ...
        $this->v1 = new Google_Service_FirebaseDynamicLinks_Resource_V1($this, $this->serviceName, 'v1', array(
            'methods' => array(
                'getLinkStats' => array(
