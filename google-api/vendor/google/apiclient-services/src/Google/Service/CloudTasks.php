...
class Google_Service_CloudTasks extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->projects_locations = new Google_Service_CloudTasks_Resource_ProjectsLocations($this, $this->serviceName, 'locations', array(
            'methods' => array(
                'get' => array(
                    'path' => 'v2beta2/{+name}',
                    'httpMethod' => 'GET',
        ...
        $this->projects_locations_queues = new Google_Service_CloudTasks_Resource_ProjectsLocationsQueues($this, $this->serviceName, 'queues', array(
            'methods' => array(
                'create' => array(
        ...
        $this->projects_locations_queues_tasks = new Google_Service_CloudTasks_Resource_ProjectsLocationsQueuesTasks($this, $this->serviceName, 'tasks', array(
            'methods' => array(
                'acknowledge' => array(
