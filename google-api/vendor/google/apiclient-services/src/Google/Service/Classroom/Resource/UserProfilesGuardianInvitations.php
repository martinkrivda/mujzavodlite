...
class Google_Service_Classroom_Resource_UserProfilesGuardianInvitations extends Google_Service_Resource
{
     ...
     *
     * @param string $studentId
     *            The ID of the student whose guardian invitation is
     *            being requested.
     * @param string $invitationId
     *            The `id` field of the `GuardianInvitation` being
     *            requested.
     * @param array $optParams
     *            Optional parameters.
     * @return Google_Service_Classroom_GuardianInvitation
     ...
     *
     * @param string $studentId
     *            The ID of the student whose guardian invitations are
     ...
     *            to be modified.
     * @param string $invitationId
     *            The `id` field of the `GuardianInvitation` to be
     *            modified.
     * @param Google_Service_Classroom_GuardianInvitation $postBody
     * @param array $optParams
     *            Optional parameters.
