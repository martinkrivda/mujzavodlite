...
class Google_Service_Classroom_Resource_Courses extends Google_Service_Resource
{
     ...
     *
     * @param string $id
     *            Identifier of the course to delete. This identifier can be
     ...
     *
     * @param string $id
     *            Identifier of the course to return. This identifier can be
     *            either the Classroom-assigned identifier or an alias.
     * @param array $optParams
     *            Optional parameters.
     * @return Google_Service_Classroom_Course
     ...
     * Returned courses are ordered by
     ...
     *
     * @param string $id
     *            Identifier of the course to update. This identifier can be
     *            either the Classroom-assigned identifier or an alias.
     * @param Google_Service_Classroom_Course $postBody
     * @param array $optParams
     *            Optional parameters.
