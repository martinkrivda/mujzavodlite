...
class Google_Service_DLP_Resource_ProjectsDeidentifyTemplates extends Google_Service_Resource
{
     ...
     * Deidentifying content, images, and storage.
    ...
    public function create($parent, Google_Service_DLP_GooglePrivacyDlpV2beta2CreateDeidentifyTemplateRequest $postBody, $optParams = array())
    {
        ...
        return $this->call('create', array(
            $params
        ), "Google_Service_DLP_GooglePrivacyDlpV2beta2DeidentifyTemplate");
    }
     ...
     *
     * @param string $name
     *            Resource name of the organization and inspectTemplate to
    ...
    public function listProjectsDeidentifyTemplates($parent, $optParams = array())
    {
        ...
        return $this->call('list', array(
            $params
        ), "Google_Service_DLP_GooglePrivacyDlpV2beta2ListDeidentifyTemplatesResponse");
    }
