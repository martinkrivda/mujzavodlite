...
class Google_Service_DLP_Resource_ProjectsContent extends Google_Service_Resource
{
     ...
     *
     * @param string $parent
     *            The parent resource name, for example projects/my-
     *            project-id.
    ...
    public function deidentify($parent, Google_Service_DLP_GooglePrivacyDlpV2beta2DeidentifyContentRequest $postBody, $optParams = array())
    {
        ...
        return $this->call('deidentify', array(
            $params
        ), "Google_Service_DLP_GooglePrivacyDlpV2beta2DeidentifyContentResponse");
    }

    /**
     * Finds potentially sensitive info in content.
     * This method has limits on input
    ...
    public function inspect($parent, Google_Service_DLP_GooglePrivacyDlpV2beta2InspectContentRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('inspect', array(
            $params
    ...
    public function reidentify($parent, Google_Service_DLP_GooglePrivacyDlpV2beta2ReidentifyContentRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('reidentify', array(
            $params
        ), "Google_Service_DLP_GooglePrivacyDlpV2beta2ReidentifyContentResponse");
    }
}
