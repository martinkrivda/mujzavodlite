...
class Google_Service_Dialogflow extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->projects = new Google_Service_Dialogflow_Resource_Projects($this, $this->serviceName, 'projects', array(
            'methods' => array(
                'getAgent' => array(
        ...
        $this->projects_agent = new Google_Service_Dialogflow_Resource_ProjectsAgent($this, $this->serviceName, 'agent', array(
            'methods' => array(
                'export' => array(
        ...
        $this->projects_agent_entityTypes = new Google_Service_Dialogflow_Resource_ProjectsAgentEntityTypes($this, $this->serviceName, 'entityTypes', array(
            'methods' => array(
                'batchDelete' => array(
        ...
        $this->projects_agent_entityTypes_entities = new Google_Service_Dialogflow_Resource_ProjectsAgentEntityTypesEntities($this, $this->serviceName, 'entities', array(
            'methods' => array(
                'batchCreate' => array(
        ...
        $this->projects_agent_intents = new Google_Service_Dialogflow_Resource_ProjectsAgentIntents($this, $this->serviceName, 'intents', array(
            'methods' => array(
                'batchDelete' => array(
        ...
        $this->projects_agent_sessions = new Google_Service_Dialogflow_Resource_ProjectsAgentSessions($this, $this->serviceName, 'sessions', array(
            'methods' => array(
        ...
        $this->projects_agent_sessions_contexts = new Google_Service_Dialogflow_Resource_ProjectsAgentSessionsContexts($this, $this->serviceName, 'contexts', array(
            'methods' => array(
                'create' => array(
                    'path' => 'v2beta1/{+parent}/contexts',
                    'httpMethod' => 'POST',
        ...
        $this->projects_agent_sessions_entityTypes = new Google_Service_Dialogflow_Resource_ProjectsAgentSessionsEntityTypes($this, $this->serviceName, 'entityTypes', array(
            'methods' => array(
                'create' => array(
                    'path' => 'v2beta1/{+parent}/entityTypes',
                    'httpMethod' => 'POST',
        ...
        $this->projects_operations = new Google_Service_Dialogflow_Resource_ProjectsOperations($this, $this->serviceName, 'operations', array(
            'methods' => array(
                'get' => array(
                    'path' => 'v2beta1/{+name}',
                    'httpMethod' => 'GET',
