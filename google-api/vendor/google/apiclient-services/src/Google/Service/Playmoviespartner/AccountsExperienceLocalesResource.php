...
class Google_Service_Playmoviespartner_AccountsExperienceLocalesResource extends Google_Service_Resource
{
    ...
    /**
     * Get an ExperienceLocale given its id.
     * See _Authentication and Authorization
     * rules_ and _Get methods rules_ for more information about this method.
     * (experienceLocales.get)
     *
     * @param string $accountId
     *            REQUIRED. See _General rules_ for more information
     *            about this field.
     * @param string $elId
    ...
    /**
     * List ExperienceLocales owned or managed by the partner.
     * See _Authentication
