...
class Google_Service_YouTubeReporting extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->jobs = new Google_Service_YouTubeReporting_Resource_Jobs($this, $this->serviceName, 'jobs', array(
            'methods' => array(
                'create' => array(
                    'path' => 'v1/jobs',
                    'httpMethod' => 'POST',
        ...
        $this->jobs_reports = new Google_Service_YouTubeReporting_Resource_JobsReports($this, $this->serviceName, 'reports', array(
            'methods' => array(
                'get' => array(
        ...
        $this->media = new Google_Service_YouTubeReporting_Resource_Media($this, $this->serviceName, 'media', array(
            'methods' => array(
                'download' => array(
        ...
        $this->reportTypes = new Google_Service_YouTubeReporting_Resource_ReportTypes($this, $this->serviceName, 'reportTypes', array(
            'methods' => array(
                'list' => array(
                    'path' => 'v1/reportTypes',
                    'httpMethod' => 'GET',
