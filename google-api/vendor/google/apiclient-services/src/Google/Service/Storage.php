...
class Google_Service_Storage extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->bucketAccessControls = new Google_Service_Storage_Resource_BucketAccessControls($this, $this->serviceName, 'bucketAccessControls', array(
            'methods' => array(
                'delete' => array(
        ...
        $this->buckets = new Google_Service_Storage_Resource_Buckets($this, $this->serviceName, 'buckets', array(
            'methods' => array(
                'delete' => array(
                    'path' => 'b/{bucket}',
                    'httpMethod' => 'DELETE',
        ...
        $this->channels = new Google_Service_Storage_Resource_Channels($this, $this->serviceName, 'channels', array(
            'methods' => array(
                'stop' => array(
                    'path' => 'channels/stop',
                    'httpMethod' => 'POST',
        ...
        $this->defaultObjectAccessControls = new Google_Service_Storage_Resource_DefaultObjectAccessControls($this, $this->serviceName, 'defaultObjectAccessControls', array(
            'methods' => array(
                'delete' => array(
        ...
        $this->notifications = new Google_Service_Storage_Resource_Notifications($this, $this->serviceName, 'notifications', array(
            'methods' => array(
                'delete' => array(
        ...
        $this->objectAccessControls = new Google_Service_Storage_Resource_ObjectAccessControls($this, $this->serviceName, 'objectAccessControls', array(
            'methods' => array(
                'delete' => array(
        ...
        $this->objects = new Google_Service_Storage_Resource_Objects($this, $this->serviceName, 'objects',
            array(
                'methods' => array(
                    'compose' => array(
        ...
        $this->projects_serviceAccount = new Google_Service_Storage_Resource_ProjectsServiceAccount($this, $this->serviceName, 'serviceAccount', array(
            'methods' => array(
                'get' => array(
