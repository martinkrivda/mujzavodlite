...
class Google_Service_CloudSourceRepositories_Resource_ProjectsRepos extends Google_Service_Resource
{
     ...
     *
     * @param string $parent
     *            The project in which to create the repo. Values are of
     *            the form `projects/`.
     ...
     *
     * @param string $name
     *            The name of the requested repository. Values are of the
     *            form `projects//repos/`.
     * @param array $optParams
     *            Optional parameters.
     * @return Google_Service_CloudSourceRepositories_Repo
     ...
     * The sizes of the repos are not set
     * by ListRepos. To get the size of a repo, use GetRepo.
     * (repos.listProjectsRepos)
     *
     * @param string $name
     *            The project ID whose repos should be listed. Values are
