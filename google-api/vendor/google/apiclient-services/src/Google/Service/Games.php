...
class Google_Service_Games extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->achievementDefinitions = new Google_Service_Games_Resource_AchievementDefinitions($this, $this->serviceName, 'achievementDefinitions', array(
            'methods' => array(
                'list' => array(
                    'path' => 'achievements',
                    'httpMethod' => 'GET',
        ...
        $this->achievements = new Google_Service_Games_Resource_Achievements($this, $this->serviceName, 'achievements', array(
            'methods' => array(
                'increment' => array(
        ...
        $this->applications = new Google_Service_Games_Resource_Applications($this, $this->serviceName, 'applications', array(
            'methods' => array(
                'get' => array(
        ...
        $this->events = new Google_Service_Games_Resource_Events($this, $this->serviceName, 'events', array(
            'methods' => array(
                'listByPlayer' => array(
                    'path' => 'events',
                    'httpMethod' => 'GET',
        ...
        $this->leaderboards = new Google_Service_Games_Resource_Leaderboards($this, $this->serviceName, 'leaderboards', array(
            'methods' => array(
                'get' => array(
        ...
        $this->metagame = new Google_Service_Games_Resource_Metagame($this, $this->serviceName, 'metagame', array(
            'methods' => array(
        ...
        $this->players = new Google_Service_Games_Resource_Players($this, $this->serviceName, 'players', array(
            'methods' => array(
                'get' => array(
        ...
        $this->pushtokens = new Google_Service_Games_Resource_Pushtokens($this, $this->serviceName, 'pushtokens', array(
            'methods' => array(
                'remove' => array(
        ...
        $this->questMilestones = new Google_Service_Games_Resource_QuestMilestones($this, $this->serviceName, 'questMilestones', array(
            'methods' => array(
                'claim' => array(
        ...
        $this->quests = new Google_Service_Games_Resource_Quests($this, $this->serviceName, 'quests', array(
            'methods' => array(
                'accept' => array(
        ...
        $this->revisions = new Google_Service_Games_Resource_Revisions($this, $this->serviceName, 'revisions', array(
            'methods' => array(
                'check' => array(
        ...
        $this->rooms = new Google_Service_Games_Resource_Rooms($this, $this->serviceName, 'rooms', array(
            'methods' => array(
                'create' => array(
                    'path' => 'rooms/create',
                    'httpMethod' => 'POST',
        ...
        $this->scores = new Google_Service_Games_Resource_Scores($this, $this->serviceName, 'scores', array(
            'methods' => array(
                'get' => array(
        ...
        $this->snapshots = new Google_Service_Games_Resource_Snapshots($this, $this->serviceName, 'snapshots', array(
            'methods' => array(
                'get' => array(
        ...
        $this->turnBasedMatches = new Google_Service_Games_Resource_TurnBasedMatches($this, $this->serviceName, 'turnBasedMatches',
            array(
                'methods' => array(
                    'cancel' => array(
