...
class Google_Service_Blogger extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->blogUserInfos = new Google_Service_Blogger_Resource_BlogUserInfos($this, $this->serviceName, 'blogUserInfos', array(
            'methods' => array(
                'get' => array(
        ...
        $this->blogs = new Google_Service_Blogger_Resource_Blogs($this, $this->serviceName, 'blogs', array(
            'methods' => array(
                'get' => array(
                    'path' => 'blogs/{blogId}',
                    'httpMethod' => 'GET',
        ...
        $this->comments = new Google_Service_Blogger_Resource_Comments($this, $this->serviceName, 'comments', array(
            'methods' => array(
                'approve' => array(
        ...
        $this->pageViews = new Google_Service_Blogger_Resource_PageViews($this, $this->serviceName, 'pageViews', array(
            'methods' => array(
                'get' => array(
        ...
        $this->pages = new Google_Service_Blogger_Resource_Pages($this, $this->serviceName, 'pages', array(
            'methods' => array(
                'delete' => array(
        ...
        $this->postUserInfos = new Google_Service_Blogger_Resource_PostUserInfos($this, $this->serviceName, 'postUserInfos', array(
            'methods' => array(
                'get' => array(
        ...
        $this->posts = new Google_Service_Blogger_Resource_Posts($this, $this->serviceName, 'posts',
            array(
                'methods' => array(
                    'delete' => array(
        ...
        $this->users = new Google_Service_Blogger_Resource_Users($this, $this->serviceName, 'users', array(
            'methods' => array(
                'get' => array(
                    'path' => 'users/{userId}',
                    'httpMethod' => 'GET',
