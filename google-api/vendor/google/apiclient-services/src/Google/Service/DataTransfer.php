...
class Google_Service_DataTransfer extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->applications = new Google_Service_DataTransfer_Resource_Applications($this, $this->serviceName, 'applications', array(
            'methods' => array(
                'get' => array(
        ...
        $this->transfers = new Google_Service_DataTransfer_Resource_Transfers($this, $this->serviceName, 'transfers', array(
            'methods' => array(
                'get' => array(
