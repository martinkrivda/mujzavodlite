...
class Google_Service_Clouderrorreporting extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->projects = new Google_Service_Clouderrorreporting_Resource_Projects($this, $this->serviceName, 'projects', array(
            'methods' => array(
                'deleteEvents' => array(
        ...
        $this->projects_events = new Google_Service_Clouderrorreporting_Resource_ProjectsEvents($this, $this->serviceName, 'events', array(
            'methods' => array(
                'list' => array(
                    'path' => 'v1beta1/{+projectName}/events',
                    'httpMethod' => 'GET',
        ...
        $this->projects_groupStats = new Google_Service_Clouderrorreporting_Resource_ProjectsGroupStats($this, $this->serviceName, 'groupStats', array(
            'methods' => array(
                'list' => array(
        ...
        $this->projects_groups = new Google_Service_Clouderrorreporting_Resource_ProjectsGroups($this, $this->serviceName, 'groups', array(
            'methods' => array(
                'get' => array(
