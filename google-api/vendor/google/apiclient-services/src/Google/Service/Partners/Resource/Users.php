...
class Google_Service_Partners_Resource_Users extends Google_Service_Resource
{
     ...
     * Affiliates the user to a company.
     * (users.createCompanyRelation)
     *
     * @param string $userId
     *            The ID of the user. Can be set to me to mean the
    ...
    public function createCompanyRelation($userId, Google_Service_Partners_CompanyRelation $postBody, $optParams = array())
    {
        ...
        return $this->call('createCompanyRelation', array(
            $params
    ...
    public function deleteCompanyRelation($userId, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('deleteCompanyRelation', array(
            $params
     ...
     *
     * @param string $userId
     *            Identifier of the user. Can be set to me to mean the
     *            currently authenticated user.
     * @param array $optParams
     *            Optional parameters.
     *            
     ...
     * A user can only update their own profile and should
    ...
    public function updateProfile(Google_Service_Partners_UserProfile $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('updateProfile', array(
            $params
