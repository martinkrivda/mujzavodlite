...
class Google_Service_Compute_Resource_TargetPools extends Google_Service_Resource
{
     ...
     *            Name of the region scoping this request.
     * @param string $targetPool
     *            Name of the TargetPool resource to add instances
     *            to.
     ...
     * Get a list of available target pools by
     ...
     * @param string $targetPool
     *            Name of the target pool to remove health checks
     *            from.
     ...
     *            Name of the region scoping this request.
     * @param string $targetPool
     *            Name of the TargetPool resource to remove instances
     *            from.
     ...
     *            Name of the region scoping this request.
     * @param string $targetPool
     *            Name of the TargetPool resource to set a backup
     *            pool for.
