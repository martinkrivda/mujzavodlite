...
class Google_Service_Compute_Resource_InstanceGroupManagers extends Google_Service_Resource
{
     ...
     * instance group.
     * Abandoning an instance does not delete the instance, but it
     ...
     * group.
     * Note that the instance group must not belong to a backend service.
     ...
     * instance group.
     * The instances are also removed from any target pools of which
     ...
     * the request.
     * After the group is created, it schedules an action to create
     ...
     *            Project ID for this request.
     * @param string $zone
     *            The name of the zone where you want to create the managed
     *            instance group.
    ...
    public function listManagedInstances($project, $zone, $instanceGroupManager, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('listManagedInstances', array(
            $params
     ...
     * instance group.
     * The instances are deleted and recreated using the current
     ...
     * If you increase the size, the group
     ...
     * group.
     * The templates for existing instances in the group do not change unless
     ...
     * group are assigned.
     * The target pools automatically apply to all of the
