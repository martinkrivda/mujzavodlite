...
class Google_Service_Devprojects_Resource_Projects extends Google_Service_Resource
{
    ...
    public function developerkeytoprojectid($developerKey, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('developerkeytoprojectid', array(
            $params
     ...
     * and takedowns.
     * (projects.getprojectclientstructure)
     *
    ...
    public function getprojectclientstructure(Google_Service_Devprojects_ProjectsGetProjectClientStructureRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('getprojectclientstructure', array(
            $params
     ...
     * Note that only the base data of a project will be
     ...
     * events, such as quota breaching.
     * Currently only supports emailing the users
    ...
    public function notifyowners($projectsId, Google_Service_Devprojects_ProjectsNotifyOwnersRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('notifyowners', array(
            $params
    ...
    /**
     * Update a project.
     * This method supports patch semantics. (projects.patch)
     *
     * @param string $projectId
     *            The Devconsole project ID.
     * @param Google_Service_Devprojects_ProjectData $postBody
     ...
     * found returns its numeric ID.
     * Note: in the case of Dasher-based projects the
    ...
    public function stringidtonumericid($project, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('stringidtonumericid', array(
            $params
