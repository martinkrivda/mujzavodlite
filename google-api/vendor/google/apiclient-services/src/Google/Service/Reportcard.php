...
class Google_Service_Reportcard extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->mutes = new Google_Service_Reportcard_Resource_Mutes($this, $this->serviceName, 'mutes', array(
            'methods' => array(
                'delete' => array(
                    'path' => 'mutes/{mutesId}',
                    'httpMethod' => 'DELETE',
        ...
        $this->notices = new Google_Service_Reportcard_Resource_Notices($this, $this->serviceName, 'notices', array(
            'methods' => array(
                'delete' => array(
