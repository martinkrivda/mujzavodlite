...
class Google_Service_CloudKMS_Resource_ProjectsLocationsKeyRingsCryptoKeys extends Google_Service_Resource
{
     ...
     *
     * @param string $name
     *            Required. The resource name of the CryptoKey to use for
    ...
    public function decrypt($name, Google_Service_CloudKMS_DecryptRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('decrypt', array(
            $params
     ...
     *
     * @param string $name
     *            Required. The resource name of the CryptoKey or
    ...
    public function encrypt($name, Google_Service_CloudKMS_EncryptRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('encrypt', array(
            $params
     ...
     *
     * @param string $parent
     *            Required. The resource name of the KeyRing to list, in
     ...
     *
     * @param string $name
     *            Output only. The resource name for this CryptoKey in the
    ...
    public function updatePrimaryVersion($name, Google_Service_CloudKMS_UpdateCryptoKeyPrimaryVersionRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('updatePrimaryVersion', array(
            $params
        ), "Google_Service_CloudKMS_CryptoKey");
    }
}
