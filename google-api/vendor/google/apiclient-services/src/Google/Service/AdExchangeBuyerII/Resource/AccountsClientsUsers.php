...
class Google_Service_AdExchangeBuyerII_Resource_AccountsClientsUsers extends Google_Service_Resource
{
     ...
     *            Numerical account ID of the client buyer that
     *            the user to be retrieved is associated with. (required)
     * @param string $userId
     *            Numerical identifier of the user to retrieve.
     *            (required)
     ...
     *
     * @param string $accountId
     *            Numerical account ID of the sponsor buyer of the
     *            client to list users for. (required)
     * @param string $clientAccountId
     *            The account ID of the client buyer to list
     ...
     * Only the user status can be changed on
     * update. (users.update)
     *
     * @param string $accountId
     *            Numerical account ID of the client's sponsor buyer.
