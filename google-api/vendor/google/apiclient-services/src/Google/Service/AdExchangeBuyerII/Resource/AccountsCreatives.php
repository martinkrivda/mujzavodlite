...
class Google_Service_AdExchangeBuyerII_Resource_AccountsCreatives extends Google_Service_Resource
{
     ...
     *            The account that this creative belongs to. Can be
     ...
     *
     * @param string $accountId
     *            The account to list the creatives from. Specify "-"
     ...
     * Will stop push notifications being sent to the
     * topics when the creative changes status. (creatives.stopWatching)
     *
     * @param string $accountId
     *            The account of the creative to stop notifications
     *            for.
     * @param string $creativeId
     *            The creative ID of the creative to stop
    ...
    public function stopWatching($accountId, $creativeId, Google_Service_AdExchangeBuyerII_StopWatchingCreativeRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('stopWatching', array(
            $params
     ...
     *            used to filter the response of the creatives.list method.
     * @param string $creativeId
     *            The buyer-defined creative ID of this creative. Can
    ...
    /**
     * Watches a creative.
     * Will result in push notifications being sent to the topic
