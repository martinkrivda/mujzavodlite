...
class Google_Service_Replicapool extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->instanceGroupManagers = new Google_Service_Replicapool_Resource_InstanceGroupManagers($this, $this->serviceName, 'instanceGroupManagers',
            array(
                'methods' => array(
        ...
        $this->zoneOperations = new Google_Service_Replicapool_Resource_ZoneOperations($this, $this->serviceName, 'zoneOperations', array(
            'methods' => array(
                'get' => array(
