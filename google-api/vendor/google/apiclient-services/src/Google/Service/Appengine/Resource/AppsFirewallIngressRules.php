...
class Google_Service_Appengine_Resource_AppsFirewallIngressRules extends Google_Service_Resource
{
     ...
     *
     * @param string $appsId
     *            Part of `name`. Name of the Firewall collection to set.
     ...
     *
     * @param string $appsId
     *            Part of `parent`. Name of the parent Firewall
     ...
     *
     * @param string $appsId
     *            Part of `name`. Name of the Firewall resource to
     *            delete. Example: apps/myapp/firewall/ingressRules/100.
     * @param string $ingressRulesId
     ...
     *
     * @param string $appsId
     *            Part of `parent`. Name of the Firewall collection to
