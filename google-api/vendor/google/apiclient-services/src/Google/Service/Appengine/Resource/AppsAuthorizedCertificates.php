...
class Google_Service_Appengine_Resource_AppsAuthorizedCertificates extends Google_Service_Resource
{
     ...
     * (authorizedCertificates.create)
     *
     * @param string $appsId
     *            Part of `parent`. Name of the parent Application
     ...
     * (authorizedCertificates.delete)
     *
     * @param string $appsId
     *            Part of `name`. Name of the resource to delete.
     *            Example: apps/myapp/authorizedCertificates/12345.
     * @param string $authorizedCertificatesId
     *            Part of `name`. See documentation of
     *            `appsId`.
     * @param array $optParams
     *            Optional parameters.
     ...
     * To renew a certificate and maintain
