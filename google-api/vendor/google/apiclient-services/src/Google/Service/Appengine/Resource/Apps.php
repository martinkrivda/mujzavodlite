...
class Google_Service_Appengine_Resource_Apps extends Google_Service_Resource
{
     ...
     *
     * @param string $appsId
     *            Part of `name`. Name of the Application resource to
     ...
     * account.
     * Use this method if you receive an error message about a missing
     * feature, for example, Error retrieving the App Engine service account.
     * (apps.repair)
     *
     * @param string $appsId
     *            Part of `name`. Name of the application to repair.
     *            Example: apps/myapp
