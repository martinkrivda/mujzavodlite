...
class Google_Service_FirebaseRulesAPI extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->projects = new Google_Service_FirebaseRulesAPI_Resource_Projects($this, $this->serviceName, 'projects', array(
            'methods' => array(
                'test' => array(
                    'path' => 'v1/{+name}:test',
                    'httpMethod' => 'POST',
        ...
        $this->projects_releases = new Google_Service_FirebaseRulesAPI_Resource_ProjectsReleases($this, $this->serviceName, 'releases', array(
            'methods' => array(
                'create' => array(
        ...
        $this->projects_rulesets = new Google_Service_FirebaseRulesAPI_Resource_ProjectsRulesets($this, $this->serviceName, 'rulesets', array(
            'methods' => array(
                'create' => array(
