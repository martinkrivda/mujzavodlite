...
class Google_Service_Storagetransfer extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->googleServiceAccounts = new Google_Service_Storagetransfer_Resource_GoogleServiceAccounts($this, $this->serviceName, 'googleServiceAccounts', array(
            'methods' => array(
                'get' => array(
        ...
        $this->transferJobs = new Google_Service_Storagetransfer_Resource_TransferJobs($this, $this->serviceName, 'transferJobs', array(
            'methods' => array(
                'create' => array(
        ...
        $this->transferOperations = new Google_Service_Storagetransfer_Resource_TransferOperations($this, $this->serviceName, 'transferOperations', array(
            'methods' => array(
                'cancel' => array(
                    'path' => 'v1/{+name}:cancel',
                    'httpMethod' => 'POST',
