...
class Google_Service_Spanner_Resource_ProjectsInstancesDatabases extends Google_Service_Resource
{
    ...
    public function dropDatabase($database, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('dropDatabase', array(
            $params
     ...
     * statements.
     * This method does not show pending schema updates, those may be
     ...
     *            REQUIRED: The Cloud Spanner resource for which the
     ...
     *
     * @param string $parent
     *            Required. The instance whose databases should be
     ...
     * The returned long-running operation will have
    ...
    public function updateDdl($database, Google_Service_Spanner_UpdateDatabaseDdlRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('updateDdl', array(
            $params
        ), "Google_Service_Spanner_Operation");
    }
}
