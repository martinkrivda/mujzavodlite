...
class Google_Service_Spanner_Resource_ProjectsInstancesDatabasesSessions extends Google_Service_Resource
{
     ...
     * This step can often be skipped: Read, ExecuteSql
     ...
     * The request includes the mutations to be applied to
     ...
     *
     * @param string $session
     *            Required. The session in which the transaction to be
     ...
     * A session can be used to perform transactions that
     ...
     *            Required. The database in which the new session is
     *            created.
    ...
    public function executeSql($session, Google_Service_Spanner_ExecuteSqlRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('executeSql', array(
            $params
    ...
    public function executeStreamingSql($session, Google_Service_Spanner_ExecuteSqlRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('executeStreamingSql', array(
            $params
    ...
    /**
     * Gets a session.
     * Returns `NOT_FOUND` if the session does not exist. This is
     ...
     *
     * @param string $session
     *            Required. The session in which the read should be
     *            performed.
     ...
     *
     * @param string $session
     *            Required. The session in which the transaction to roll
     *            back is running.
    ...
    public function streamingRead($session, Google_Service_Spanner_ReadRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('streamingRead', array(
            $params
        ), "Google_Service_Spanner_PartialResultSet");
    }
}
