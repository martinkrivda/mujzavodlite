...
class Google_Service_Gmail_Resource_UsersSettingsSendAs extends Google_Service_Resource
{
     ...
     * If an SMTP MSA is specified, Gmail
     ...
     * Revokes any verification that may have
     ...
     * Fails with an HTTP 404 error if the
     ...
     * If a signature is provided, Gmail will sanitize the
