...
class Google_Service_Chromewebstore_Resource_Payments extends Google_Service_Resource
{
    ...
    /**
     * Inserts a cart and returns the JWT.
     * (payments.buy)
     *
    ...
    public function buy(Google_Service_Chromewebstore_PaymentsBuyRequest $postBody, $optParams = array())
    {
        ...
        return $this->call('buy', array(
            $params
        ), "Google_Service_Chromewebstore_Jwt");
    }

    /**
     * Consumes the in-app product for the user.
     * (payments.delete)
     *
     * @param string $itemId
     *            The ID of the item to consume the in-app product.
     * @param string $sku
    ...
    public function listPayments($optParams = array())
    {
        ...
        return $this->call('list', array(
            $params
        ), "Google_Service_Chromewebstore_PaymentsListResponse");
    }
}
