...
class Google_Service_Datastore extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->projects = new Google_Service_Datastore_Resource_Projects($this, $this->serviceName, 'projects', array(
            'methods' => array(
                'allocateIds' => array(
        ...
        $this->projects_operations = new Google_Service_Datastore_Resource_ProjectsOperations($this, $this->serviceName, 'operations', array(
            'methods' => array(
                'cancel' => array(
                    'path' => 'v1/{+name}:cancel',
                    'httpMethod' => 'POST',
