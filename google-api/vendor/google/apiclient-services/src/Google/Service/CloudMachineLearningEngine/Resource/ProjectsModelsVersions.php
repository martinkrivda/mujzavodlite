...
class Google_Service_CloudMachineLearningEngine_Resource_ProjectsModelsVersions extends Google_Service_Resource
{
     ...
     *
     * @param string $name
     *            Required. The name of the version. You can get the names
     ...
     *
     * @param string $parent
     *            Required. The name of the model for which to list the
     *            version.
     * @param array $optParams
     *            Optional parameters.
     *            
     ...
     *
     * @param string $name
     *            Required. The name of the version to make the default for
    ...
    public function setDefault($name, Google_Service_CloudMachineLearningEngine_GoogleCloudMlV1SetDefaultVersionRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('setDefault', array(
            $params
        ), "Google_Service_CloudMachineLearningEngine_GoogleCloudMlV1Version");
    }
}
