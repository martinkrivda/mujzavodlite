...
class Google_Service_Prediction extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->hostedmodels = new Google_Service_Prediction_Resource_Hostedmodels($this, $this->serviceName, 'hostedmodels', array(
            'methods' => array(
                'predict' => array(
        ...
        $this->trainedmodels = new Google_Service_Prediction_Resource_Trainedmodels($this, $this->serviceName, 'trainedmodels', array(
            'methods' => array(
                'analyze' => array(
