...
class Google_Service_Reseller extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->customers = new Google_Service_Reseller_Resource_Customers($this, $this->serviceName, 'customers', array(
            'methods' => array(
                'get' => array(
        ...
        $this->resellernotify = new Google_Service_Reseller_Resource_Resellernotify($this, $this->serviceName, 'resellernotify', array(
            'methods' => array(
        ...
        $this->subscriptions = new Google_Service_Reseller_Resource_Subscriptions($this, $this->serviceName, 'subscriptions', array(
            'methods' => array(
                'activate' => array(
