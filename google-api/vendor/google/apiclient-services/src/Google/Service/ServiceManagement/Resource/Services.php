...
class Google_Service_ServiceManagement_Resource_Services extends Google_Service_Resource
{
     ...
     * Please note one producer project can own no
     ...
     * This method will change the service to the `Soft-
     ...
     * project.
     * It prevents accidental usage that may cause unexpected billing
     * charges or security leaks.
     *
     * Operation (services.disable)
     *
     * @param string $serviceName
     *            Name of the service to disable. Specifying an
    ...
    public function disable($serviceName, Google_Service_ServiceManagement_DisableServiceRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('disable', array(
            $params
        ), "Google_Service_ServiceManagement_Operation");
    }
     ...
     *
     * @param string $serviceName
     *            Name of the service to enable. Specifying an
     *            unknown service name will cause the request to fail.
    ...
    public function generateConfigReport(Google_Service_ServiceManagement_GenerateConfigReportRequest $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('generateConfigReport', array(
            $params
     ...
     * Authentication is required unless the service is
     * public. (services.get)
     *
     * @param string $serviceName
     *            The name of the service. See the `ServiceManager`
    ...
    public function getConfig($serviceName, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('getConfig', array(
            $params
     ...
     * The method restores the service
