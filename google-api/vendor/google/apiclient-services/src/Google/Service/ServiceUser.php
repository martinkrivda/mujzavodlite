...
class Google_Service_ServiceUser extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->projects_services = new Google_Service_ServiceUser_Resource_ProjectsServices($this, $this->serviceName, 'services', array(
            'methods' => array(
                'disable' => array(
        ...
        $this->services = new Google_Service_ServiceUser_Resource_Services($this, $this->serviceName, 'services', array(
            'methods' => array(
                'search' => array(
