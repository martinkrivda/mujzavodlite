...
class Google_Service_Firestore extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->projects_databases_documents = new Google_Service_Firestore_Resource_ProjectsDatabasesDocuments($this, $this->serviceName, 'documents', array(
            'methods' => array(
                'batchGet' => array(
        ...
        $this->projects_databases_indexes = new Google_Service_Firestore_Resource_ProjectsDatabasesIndexes($this, $this->serviceName, 'indexes', array(
            'methods' => array(
                'create' => array(
