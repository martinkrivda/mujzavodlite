...
class Google_Service_Devprojects extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->activationLinks = new Google_Service_Devprojects_Resource_ActivationLinks($this, $this->serviceName, 'activationLinks', array(
            'methods' => array(
                'insert' => array(
        ...
        $this->apiconsumers = new Google_Service_Devprojects_Resource_Apiconsumers($this, $this->serviceName, 'apiconsumers', array(
            'methods' => array(
                'delete' => array(
                    'path' => 'apiconsumers',
                    'httpMethod' => 'DELETE',
        ...
        $this->apis = new Google_Service_Devprojects_Resource_Apis($this, $this->serviceName, 'apis', array(
            'methods' => array(
                'get' => array(
                    'path' => 'apis/{apisId}',
                    'httpMethod' => 'GET',
        ...
        $this->controlwidgets = new Google_Service_Devprojects_Resource_Controlwidgets($this, $this->serviceName, 'controlwidgets', array(
            'methods' => array(
                'embed' => array(
        ...
        $this->domains = new Google_Service_Devprojects_Resource_Domains($this, $this->serviceName, 'domains', array(
            'methods' => array(
                'get' => array(
        ...
        $this->projects = new Google_Service_Devprojects_Resource_Projects($this, $this->serviceName, 'projects', array(
            'methods' => array(
                'delete' => array(
        ...
        $this->toses = new Google_Service_Devprojects_Resource_Toses($this, $this->serviceName, 'toses', array(
            'methods' => array(
                'accept' => array(
                    'path' => 'toses/accept',
                    'httpMethod' => 'POST',
        ...
        $this->users = new Google_Service_Devprojects_Resource_Users($this, $this->serviceName, 'users', array(
            'methods' => array(
                'get' => array(
                    'path' => 'users/{userId}',
                    'httpMethod' => 'GET',
