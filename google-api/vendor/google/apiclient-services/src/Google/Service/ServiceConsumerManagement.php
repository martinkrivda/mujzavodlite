...
class Google_Service_ServiceConsumerManagement extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->operations = new Google_Service_ServiceConsumerManagement_Resource_Operations($this, $this->serviceName, 'operations', array(
            'methods' => array(
                'cancel' => array(
                    'path' => 'v1/{+name}:cancel',
                    'httpMethod' => 'POST',
        ...
        $this->services = new Google_Service_ServiceConsumerManagement_Resource_Services($this, $this->serviceName, 'services', array(
            'methods' => array(
                'search' => array(
        ...
        $this->services_tenancyUnits = new Google_Service_ServiceConsumerManagement_Resource_ServicesTenancyUnits($this, $this->serviceName, 'tenancyUnits', array(
            'methods' => array(
                'addProject' => array(
