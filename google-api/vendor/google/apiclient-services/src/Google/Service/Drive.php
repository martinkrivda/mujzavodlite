...
class Google_Service_Drive extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->about = new Google_Service_Drive_Resource_About($this, $this->serviceName, 'about', array(
            'methods' => array(
                'get' => array(
                    'path' => 'about',
                    'httpMethod' => 'GET',
        ...
        $this->changes = new Google_Service_Drive_Resource_Changes($this, $this->serviceName, 'changes', array(
            'methods' => array(
        ...
        $this->channels = new Google_Service_Drive_Resource_Channels($this, $this->serviceName, 'channels', array(
            'methods' => array(
                'stop' => array(
                    'path' => 'channels/stop',
                    'httpMethod' => 'POST',
        ...
        $this->comments = new Google_Service_Drive_Resource_Comments($this, $this->serviceName, 'comments', array(
            'methods' => array(
                'create' => array(
        ...
        $this->files = new Google_Service_Drive_Resource_Files($this, $this->serviceName, 'files', array(
            'methods' => array(
                'copy' => array(
        ...
        $this->permissions = new Google_Service_Drive_Resource_Permissions($this, $this->serviceName, 'permissions', array(
            'methods' => array(
                'create' => array(
        ...
        $this->replies = new Google_Service_Drive_Resource_Replies($this, $this->serviceName, 'replies', array(
            'methods' => array(
                'create' => array(
        ...
        $this->revisions = new Google_Service_Drive_Resource_Revisions($this, $this->serviceName, 'revisions', array(
            'methods' => array(
                'delete' => array(
        ...
        $this->teamdrives = new Google_Service_Drive_Resource_Teamdrives($this, $this->serviceName, 'teamdrives', array(
            'methods' => array(
                'create' => array(
                    'path' => 'teamdrives',
                    'httpMethod' => 'POST',
