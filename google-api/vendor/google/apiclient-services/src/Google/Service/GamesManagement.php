...
class Google_Service_GamesManagement extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->achievements = new Google_Service_GamesManagement_Resource_Achievements($this, $this->serviceName, 'achievements', array(
            'methods' => array(
                'reset' => array(
        ...
        $this->applications = new Google_Service_GamesManagement_Resource_Applications($this, $this->serviceName, 'applications', array(
            'methods' => array(
                'listHidden' => array(
        ...
        $this->events = new Google_Service_GamesManagement_Resource_Events($this, $this->serviceName, 'events', array(
            'methods' => array(
                'reset' => array(
        ...
        $this->players = new Google_Service_GamesManagement_Resource_Players($this, $this->serviceName, 'players', array(
            'methods' => array(
                'hide' => array(
        ...
        $this->quests = new Google_Service_GamesManagement_Resource_Quests($this, $this->serviceName, 'quests', array(
            'methods' => array(
                'reset' => array(
        ...
        $this->rooms = new Google_Service_GamesManagement_Resource_Rooms($this, $this->serviceName, 'rooms', array(
            'methods' => array(
                'reset' => array(
                    'path' => 'rooms/reset',
                    'httpMethod' => 'POST',
        ...
        $this->scores = new Google_Service_GamesManagement_Resource_Scores($this, $this->serviceName, 'scores', array(
            'methods' => array(
                'reset' => array(
        ...
        $this->turnBasedMatches = new Google_Service_GamesManagement_Resource_TurnBasedMatches($this, $this->serviceName, 'turnBasedMatches', array(
            'methods' => array(
                'reset' => array(
