...
class Google_Service_People extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->people = new Google_Service_People_Resource_People($this, $this->serviceName, 'people', array(
            'methods' => array(
                'get' => array(
        ...
        $this->people_connections = new Google_Service_People_Resource_PeopleConnections($this, $this->serviceName, 'connections', array(
            'methods' => array(
                'list' => array(
