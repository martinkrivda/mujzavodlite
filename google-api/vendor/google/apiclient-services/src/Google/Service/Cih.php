...
class Google_Service_Cih extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->associatedEmails = new Google_Service_Cih_Resource_AssociatedEmails($this, $this->serviceName, 'associatedEmails', array(
            'methods' => array(
                'create' => array(
        ...
        $this->userInteractions = new Google_Service_Cih_Resource_UserInteractions($this, $this->serviceName, 'userInteractions', array(
            'methods' => array(
                'get' => array(
