...
class Google_Service_PlayMovies extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->accounts_avails = new Google_Service_PlayMovies_Resource_AccountsAvails($this, $this->serviceName, 'avails', array(
            'methods' => array(
                'get' => array(
        ...
        $this->accounts_orders = new Google_Service_PlayMovies_Resource_AccountsOrders($this, $this->serviceName, 'orders', array(
            'methods' => array(
                'get' => array(
        ...
        $this->accounts_storeInfos = new Google_Service_PlayMovies_Resource_AccountsStoreInfos($this, $this->serviceName, 'storeInfos', array(
            'methods' => array(
                'list' => array(
        ...
        $this->accounts_storeInfos_country = new Google_Service_PlayMovies_Resource_AccountsStoreInfosCountry($this, $this->serviceName, 'country', array(
            'methods' => array(
                'get' => array(
