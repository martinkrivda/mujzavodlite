...
class Google_Service_TPU extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->projects_locations = new Google_Service_TPU_Resource_ProjectsLocations($this, $this->serviceName, 'locations', array(
            'methods' => array(
                'get' => array(
                    'path' => 'v1alpha1/{+name}',
                    'httpMethod' => 'GET',
        ...
        $this->projects_locations_nodes = new Google_Service_TPU_Resource_ProjectsLocationsNodes($this, $this->serviceName, 'nodes', array(
            'methods' => array(
                'create' => array(
        ...
        $this->projects_locations_operations = new Google_Service_TPU_Resource_ProjectsLocationsOperations($this, $this->serviceName, 'operations', array(
            'methods' => array(
                'cancel' => array(
