...
class Google_Service_Proximitybeacon extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->beaconinfo = new Google_Service_Proximitybeacon_Resource_Beaconinfo($this, $this->serviceName, 'beaconinfo', array(
            'methods' => array(
        ...
        $this->beacons = new Google_Service_Proximitybeacon_Resource_Beacons($this, $this->serviceName, 'beacons', array(
            'methods' => array(
                'activate' => array(
        ...
        $this->beacons_attachments = new Google_Service_Proximitybeacon_Resource_BeaconsAttachments($this, $this->serviceName, 'attachments', array(
            'methods' => array(
                'batchDelete' => array(
        ...
        $this->beacons_diagnostics = new Google_Service_Proximitybeacon_Resource_BeaconsDiagnostics($this, $this->serviceName, 'diagnostics', array(
            'methods' => array(
                'list' => array(
        ...
        $this->namespaces = new Google_Service_Proximitybeacon_Resource_Namespaces($this, $this->serviceName, 'namespaces', array(
            'methods' => array(
                'list' => array(
        ...
        $this->v1beta1 = new Google_Service_Proximitybeacon_Resource_V1beta1($this, $this->serviceName, 'v1beta1', array(
            'methods' => array(
                'getEidparams' => array(
