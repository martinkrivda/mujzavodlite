...
class Google_Service_Appengine extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->apps = new Google_Service_Appengine_Resource_Apps($this, $this->serviceName, 'apps', array(
            'methods' => array(
                'create' => array(
                    'path' => 'v1/apps',
                    'httpMethod' => 'POST',
        ...
        $this->apps_authorizedCertificates = new Google_Service_Appengine_Resource_AppsAuthorizedCertificates($this, $this->serviceName, 'authorizedCertificates', array(
            'methods' => array(
                'create' => array(
        ...
        $this->apps_authorizedDomains = new Google_Service_Appengine_Resource_AppsAuthorizedDomains($this, $this->serviceName, 'authorizedDomains', array(
            'methods' => array(
                'list' => array(
        ...
        $this->apps_domainMappings = new Google_Service_Appengine_Resource_AppsDomainMappings($this, $this->serviceName, 'domainMappings', array(
            'methods' => array(
                'create' => array(
        ...
        $this->apps_firewall_ingressRules = new Google_Service_Appengine_Resource_AppsFirewallIngressRules($this, $this->serviceName, 'ingressRules', array(
            'methods' => array(
                'batchUpdate' => array(
        ...
        $this->apps_locations = new Google_Service_Appengine_Resource_AppsLocations($this, $this->serviceName, 'locations', array(
            'methods' => array(
                'get' => array(
        ...
        $this->apps_operations = new Google_Service_Appengine_Resource_AppsOperations($this, $this->serviceName, 'operations', array(
            'methods' => array(
                'get' => array(
        ...
        $this->apps_services = new Google_Service_Appengine_Resource_AppsServices($this, $this->serviceName, 'services', array(
            'methods' => array(
                'delete' => array(
        ...
        $this->apps_services_versions = new Google_Service_Appengine_Resource_AppsServicesVersions($this, $this->serviceName, 'versions', array(
            'methods' => array(
                'create' => array(
        ...
        $this->apps_services_versions_instances = new Google_Service_Appengine_Resource_AppsServicesVersionsInstances($this, $this->serviceName, 'instances', array(
            'methods' => array(
                'debug' => array(
