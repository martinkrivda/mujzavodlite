...
class Google_Service_Testing extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->projects_testMatrices = new Google_Service_Testing_Resource_ProjectsTestMatrices($this, $this->serviceName, 'testMatrices', array(
            'methods' => array(
                'cancel' => array(
        ...
        $this->testEnvironmentCatalog = new Google_Service_Testing_Resource_TestEnvironmentCatalog($this, $this->serviceName, 'testEnvironmentCatalog', array(
            'methods' => array(
                'get' => array(
