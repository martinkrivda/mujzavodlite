...
class Google_Service_Taskqueue extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->taskqueues = new Google_Service_Taskqueue_Resource_Taskqueues($this, $this->serviceName, 'taskqueues', array(
            'methods' => array(
                'get' => array(
        ...
        $this->tasks = new Google_Service_Taskqueue_Resource_Tasks($this, $this->serviceName, 'tasks', array(
            'methods' => array(
                'delete' => array(
