...
class Google_Service_Tracing extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->projects_traces = new Google_Service_Tracing_Resource_ProjectsTraces($this, $this->serviceName, 'traces', array(
            'methods' => array(
                'batchWrite' => array(
        ...
        $this->projects_traces_spans = new Google_Service_Tracing_Resource_ProjectsTracesSpans($this, $this->serviceName, 'spans', array(
            'methods' => array(
                'create' => array(
                    'path' => 'v2/{+name}',
                    'httpMethod' => 'PUT',
