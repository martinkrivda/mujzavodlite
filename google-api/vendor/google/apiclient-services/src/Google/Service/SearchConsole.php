...
class Google_Service_SearchConsole extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->urlTestingTools_mobileFriendlyTest = new Google_Service_SearchConsole_Resource_UrlTestingToolsMobileFriendlyTest($this, $this->serviceName, 'mobileFriendlyTest', array(
            'methods' => array(
                'run' => array(
