...
class Google_Service_Partners extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->analytics = new Google_Service_Partners_Resource_Analytics($this, $this->serviceName, 'analytics', array(
            'methods' => array(
                'list' => array(
                    'path' => 'v2/analytics',
                    'httpMethod' => 'GET',
        ...
        $this->clientMessages = new Google_Service_Partners_Resource_ClientMessages($this, $this->serviceName, 'clientMessages', array(
            'methods' => array(
                'log' => array(
        ...
        $this->companies = new Google_Service_Partners_Resource_Companies($this, $this->serviceName, 'companies', array(
            'methods' => array(
                'get' => array(
        ...
        $this->companies_leads = new Google_Service_Partners_Resource_CompaniesLeads($this, $this->serviceName, 'leads', array(
            'methods' => array(
                'create' => array(
        ...
        $this->exams = new Google_Service_Partners_Resource_Exams($this, $this->serviceName, 'exams', array(
            'methods' => array(
                'getToken' => array(
        ...
        $this->leads = new Google_Service_Partners_Resource_Leads($this, $this->serviceName, 'leads', array(
            'methods' => array(
                'list' => array(
                    'path' => 'v2/leads',
                    'httpMethod' => 'GET',
        ...
        $this->offers = new Google_Service_Partners_Resource_Offers($this, $this->serviceName, 'offers', array(
            'methods' => array(
                'list' => array(
                    'path' => 'v2/offers',
                    'httpMethod' => 'GET',
        ...
        $this->offers_history = new Google_Service_Partners_Resource_OffersHistory($this, $this->serviceName, 'history', array(
            'methods' => array(
                'list' => array(
        ...
        $this->userEvents = new Google_Service_Partners_Resource_UserEvents($this, $this->serviceName, 'userEvents', array(
            'methods' => array(
                'log' => array(
        ...
        $this->userStates = new Google_Service_Partners_Resource_UserStates($this, $this->serviceName, 'userStates', array(
            'methods' => array(
                'list' => array(
                    'path' => 'v2/userStates',
                    'httpMethod' => 'GET',
        ...
        $this->users = new Google_Service_Partners_Resource_Users($this, $this->serviceName, 'users', array(
            'methods' => array(
        ...
        $this->v2 = new Google_Service_Partners_Resource_V2($this, $this->serviceName, 'v2', array(
            'methods' => array(
