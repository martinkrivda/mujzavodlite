...
class AuthTokenSubscriberTest extends BaseTest
{
    ...
    public function testAddsTheTokenAsAnAuthorizationHeader()
    {
        ...
        $this->mockFetcher->expects($this->once())
    ...
    {
        $authResult = [
            'not_access_token' => '1/abcdef1234567890'
        ];
        $this->mockFetcher->expects($this->once())
            ->method('fetchAuthToken')
            ->will($this->returnValue($authResult));
    ...
    public function testUsesCachedAuthToken()
    {
        ...
        $this->mockFetcher->expects($this->never())
            ->method('fetchAuthToken');
        $this->mockFetcher->expects($this->any())
            ->method('getCacheKey')
    ...
    public function testGetsCachedAuthTokenUsingCachePrefix()
    {
        ...
        // Run the test
        $cachedFetcher = new FetchAuthTokenCache($this->mockFetcher, [
            'prefix' => $prefix
        ], $this->mockCache);
        $a = new AuthTokenSubscriber($cachedFetcher);
        $client = new Client();
    ...
    public function testShouldSaveValueInCacheWithCacheOptions()
    {
        ...
        $this->mockCacheItem->expects($this->any())
            ->method('get')
    ...
    public function provideShouldNotifyTokenCallback()
    {
        ...
        return [
            ...
            [
                [
                    'Google\Auth\Tests\SubscriberCallback',
                    'staticInvoke'
                ]
            ],
            [
