...
class SACFetchAuthTokenTest extends TestCase
{
    ...
    public function testUpdateMetadataFunc()
    {
        ...
        $actual_metadata = call_user_func($update_metadata, $metadata = array(
            'foo' => 'bar'
        ), $authUri = null, $httpHandler);
        $this->assertArrayHasKey(CredentialsLoader::AUTH_METADATA_KEY, $actual_metadata);
        $this->assertEquals($actual_metadata[CredentialsLoader::AUTH_METADATA_KEY], array(
            'Bearer ' . $access_token
        ));
    }
}
...
class SACJwtAccessTest extends TestCase
{
    ...
    public function testUpdateMetadataFunc()
    {
        ...
        $actual_metadata2 = call_user_func($update_metadata, $metadata = array(
            'foo' => 'bar'
